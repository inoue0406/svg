...
def make_gifs(x, idx, name,conv_predictor,frame_predictor,encoder,decoder):
...
def plot_comp_prediction(opt,df_sampled,mode='png_ind'):
    ...
    for i in range(0, opt.N, opt.batch_size):
        ...
        make_gifs(train_x, i, 'train',conv_predictor,frame_predictor,encoder,decoder)
        
        # plot test
        test_x = next(testing_batch_generator)
        make_gifs(test_x, i, 'test',conv_predictor,frame_predictor,encoder,decoder)
        break
